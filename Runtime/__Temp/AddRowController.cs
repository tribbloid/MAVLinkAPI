...
public class AddRowController : MonoBehaviour
{
    ...
    [SerializeField] 
    private RectTransform? outerContent;
    
    [SerializeField]
    private string[] placeholderTexts = new string[] { "Item", "Description", "Value" };
    ...
    public void AddRow()
    {
        if (tableLayout != null)
        {
            ...
            var rowGameObject = TableLayoutUtilities.InstantiatePrefab("TableLayout/Row");
